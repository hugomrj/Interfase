...
@WebServlet(name = "InteraccionControllerAgregar",
        urlPatterns = {"/Interaccion/Agregar.do"})


public class InteraccionControllerAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia =(Interaccion) persistencia.insert(instancia, request);
            ...
            Logger.getLogger(InteraccionControllerAgregar.class.getName()).log(Level.SEVERE, null, ex);
        }
