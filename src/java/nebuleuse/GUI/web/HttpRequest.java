...
public  class HttpRequest {
    ...
    public void NumeracionPaginacion (HttpServletRequest request, Object objeto, Secuencia<Proveedor> lista ) 
            throws Exception {
        ...
        request.getSession().setAttribute("SessionPaginaTotalRegistros", 
            lista.TotalRegistros(objeto, strBuscar)); 
