...
@WebServlet(name = "VentaTransaccionCancelar",
        urlPatterns = {"/Venta/Transaccion/Cancelar.do"})


public class VentaTransaccionCancelar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VentaTransaccionCancelar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
