...
@WebServlet(name = "CompraDetalleTransaccionSessionBorrar",
        urlPatterns = {"/CompraDetalle/Session/Borrar.do"})


public class CompraDetalleTransaccionSessionBorrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            // borrar
            coleccion.remove( Integer.parseInt(request.getParameter("id"))  );
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CompraDetalleTransaccionSessionBorrar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
