...
@WebServlet(name = "ProductoActionSubConsulta",
        urlPatterns = {"/Producto/SubConsulta.do"})


public class ProductoActionSubConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Producto> SessionLista = new ArrayList<Producto>();
        
        lista.subLineas = 10;
        SessionLista = lista.listaColeccion( new Producto(), null, strBuscar, pagina );   
       ...
       // request.setAttribute("session_consulta", SessionLista );            
        ...
        request.setAttribute("TotalRegistros", lista.TotalRegistros(new Producto(), strBuscar) );         
        ...
        request.getRequestDispatcher("/Producto/Sub/Consulta.jspx").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProductoActionSubConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
