...
@WebServlet(name = "CompraDetalleTransaccionSumaSubtotal",
        urlPatterns = {"/CompraDetalle/Suma/Subtotal.do"})


public class CompraDetalleTransaccionSumaSubtotal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            else
            {
                ...
                for (CompraDetalle detalle : coleccion) {                                
                    suma = suma + detalle.getSub_total();                                      
                }                
                    out.print(suma);                
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CompraDetalleTransaccionSumaSubtotal.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
