...
@WebServlet(name = "InteraccionActionSubConsulta",
        urlPatterns = {"/Interaccion/SubConsulta.do"})


public class InteraccionActionSubConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Interaccion> SessionLista = new ArrayList<Interaccion>();
        
        lista.subLineas = 10;
        SessionLista = lista.listaColeccion( new Interaccion(), null, strBuscar, pagina );   
       ...
       // request.setAttribute("session_consulta", SessionLista );            
        ...
        request.setAttribute("TotalRegistros", lista.TotalRegistros(new Interaccion(), strBuscar) );         
        ...
        request.getRequestDispatcher("/Interaccion/Sub/Consulta.jspx").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(InteraccionActionSubConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
