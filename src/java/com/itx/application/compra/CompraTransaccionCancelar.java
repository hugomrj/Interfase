...
@WebServlet(name = "CompraTransaccionCancelar",
        urlPatterns = {"/Compra/Transaccion/Cancelar.do"})


public class CompraTransaccionCancelar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CompraTransaccionCancelar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
