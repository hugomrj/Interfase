...
@WebServlet(name = "CategoriaActionSubConsulta",
        urlPatterns = {"/Categoria/SubConsulta.do"})


public class CategoriaActionSubConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Categoria> SessionLista = new ArrayList<Categoria>();
        
        lista.subLineas = 10;
        SessionLista = lista.listaColeccion( new Categoria(), null, strBuscar, pagina );   
       ...
       // request.setAttribute("session_consulta", SessionLista );            
        ...
        request.setAttribute("TotalRegistros", lista.TotalRegistros(new Categoria(), strBuscar) );         
        ...
        request.getRequestDispatcher("/Categoria/Sub/Consulta.jspx").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CategoriaActionSubConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
