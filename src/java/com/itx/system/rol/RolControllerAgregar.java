...
@WebServlet(name = "RolControllerAgregar",
        urlPatterns = {"/Rol/Agregar.do"})


public class RolControllerAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia =  (Rol) persistencia.insert(instancia, request);
            ...
            Logger.getLogger(RolControllerAgregar.class.getName()).log(Level.SEVERE, null, ex);
        }
