...
@WebServlet(name = "CompraDetalleTransaccionSumaPrecio",
        urlPatterns = {"/CompraDetalle/Suma/Precio.do"})


public class CompraDetalleTransaccionSumaPrecio extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CompraDetalleTransaccionSumaPrecio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
