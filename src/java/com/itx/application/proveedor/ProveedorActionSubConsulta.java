...
@WebServlet(name = "ProveedorActionSubConsulta",
        urlPatterns = {"/Proveedor/SubConsulta.do"})


public class ProveedorActionSubConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Proveedor> SessionLista = new ArrayList<Proveedor>();
        
        lista.subLineas = 10;
        SessionLista = lista.listaColeccion( new Proveedor(), null, strBuscar, pagina );   
       ...
       // request.setAttribute("session_consulta", SessionLista );            
        ...
        request.setAttribute("TotalRegistros", lista.TotalRegistros(new Proveedor(), strBuscar) );         
        ...
        request.getRequestDispatcher("/Proveedor/Sub/Consulta.jspx").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProveedorActionSubConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
