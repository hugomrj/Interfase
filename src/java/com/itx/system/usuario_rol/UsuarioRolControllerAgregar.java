...
@WebServlet(name = "UsuarioRolControllerAgregar", 
        urlPatterns = {"/UsuarioRol/Agregar.do"})


public class UsuarioRolControllerAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (UsuarioRol) persistencia.insert(instancia, request);
        ...
        {
            Logger.getLogger(UsuarioRolControllerAgregar.class.getName()).log(Level.SEVERE, null, ex);
        }
